...
const Lang = Language.getString('conventer');
    ...
    TOXIC_DEVIL.addCommand({pattern: 'mp4audio', fromMe: true, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    TOXIC_DEVIL.addCommand({pattern: 'imagesticker', fromMe: true, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
